            ...
            try {
                ...
                if (count($args) == 2) {
                    ...
                    if ($player != null) {
                        ...
                        $player->sendMessage(TextFormat::RED . "You have been muted by $sender Reason: " . TextFormat::AQUA . $reason . TextFormat::RED . " until " . TextFormat::AQUA . $expiryToString . TextFormat::RED . ".");
                    } else {
